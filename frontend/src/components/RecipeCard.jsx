...
export default function RecipeCard({ recipe }) {
  ...
  return (
    <section className="max-w-5xl mx-auto mt-16">
      <div className="rounded-3xl bg-white border border-[#D9D2C6] shadow-xl shadow-[#143D2A]/10 overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-5 p-8">
          ...
          <div className="rounded-2xl bg-[#F8F5EF] border border-[#E8E2D7] p-5">
            <Clock3 className="text-[#2E7D32] mb-3" />
          ...
          <div className="rounded-2xl bg-[#F8F5EF] border border-[#E8E2D7] p-5">
            <Users className="text-[#2E7D32] mb-3" />
          ...
          <div className="rounded-2xl bg-[#F8F5EF] border border-[#E8E2D7] p-5">
            <ChefHat className="text-[#2E7D32] mb-3" />
        ...
        <div className="px-8 pb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {recipe.ingredients.map((item, index) => (
              ...
              <div
                key={index}
                className="flex items-center gap-3 bg-[#F8F5EF] border border-[#E8E2D7] rounded-xl p-4 hover:border-[#C9A227] transition"
              >
        ...
        <div className="px-8 pb-8">
          ...
          <div className="space-y-4">
            ...
            {recipe.steps.map((step, index) => (
              ...
              <div
                key={index}
                className="flex gap-4 bg-[#F8F5EF] border border-[#E8E2D7] rounded-xl p-5 hover:border-[#C9A227] transition"
              >

                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#2E7D32] to-[#5BAA5B] text-white flex items-center justify-center font-bold shrink-0">
          ...
          <div className="px-8 pb-8">
            ...
            <div className="space-y-4">
              ...
              {recipe.swaps.map((swap, index) => (
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 bg-[#F8F5EF] border border-[#E8E2D7] rounded-xl p-5 hover:border-[#C9A227] transition"
                >
